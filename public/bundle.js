...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AboutPage = __webpack_require__(240);

	var _AboutPage2 = _interopRequireDefault(_AboutPage);

	var _AuthPage = __webpack_require__(241);

	var _AuthPage2 = _interopRequireDefault(_AuthPage);

	var _QuickSpeech = __webpack_require__(242);

	var _QuickSpeech2 = _interopRequireDefault(_QuickSpeech);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_reactRouter.IndexRoute, { component: _AuthPage2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IconLink = __webpack_require__(237);

	var _IconLink2 = _interopRequireDefault(_IconLink);

	var _SpeakBox = __webpack_require__(238);
	...
	var HomePage = function HomePage(props) {
	  return _react2.default.createElement(
	    'div',
	    null,
	    _react2.default.createElement(_IconLink2.default, { pathTo: "/", title: 'Login' }),
	    _react2.default.createElement(_IconLink2.default, { pathTo: "/register", title: 'Signup' }),
	    props.children,
	    _react2.default.createElement(_SpeakBox2.default, null)
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IconLink = function IconLink(props) {
	  return _react2.default.createElement(
	    _reactRouter.Link,
	    { className: 'col-xs-3 icon-link', to: props.pathTo },
	    _react2.default.createElement(
	      'h2',
	      null,
	      props.title
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _say_message = __webpack_require__(239);
	...
	var _window = window;
	var SpeechSynthesisUtterance = _window.SpeechSynthesisUtterance;

	var SpeakBox = function (_Component) {
	  _inherits(SpeakBox, _Component);

	  function SpeakBox() {
	    _classCallCheck(this, SpeakBox);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(SpeakBox).apply(this, arguments));
	  }

	  _createClass(SpeakBox, [{
	    key: 'getInputText',
	    value: function getInputText(ref) {
	      this.message = ref;
	    }
	  }, {
	    key: 'sayIt',
	    value: function sayIt(e) {
	      e.preventDefault();
	      var msg = new SpeechSynthesisUtterance();
	      (0, _say_message.setVoice)(msg, 'Carlos');
	      (0, _say_message.sayMessage)(msg, this.message.value);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'form-inline', onSubmit: this.sayIt.bind(this) },
...
/***/ function(module, exports) {
	...
	var _window = window;
	var speechSynthesis = _window.speechSynthesis;
	function setVoice(msg, voice) {
	  ...
	  msg.pitch = 1; // 0 - 2
	  msg.rate = 1; // 0.1 - 10
	  msg.voice = speechSynthesis.getVoices().find(function (v) {
	    return v.name == voice;
	  });
	  return msg;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AuthPage = function (_Component) {
	  ...
	  function AuthPage() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(AuthPage).apply(this, arguments));
	  }
	    ...
	    value: function render() {
	      ...
	      if (this.props.route.path === '/register') {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { className: 'btn btn-success', type: 'submit', value: 'Sign Up' })
	        );
	      } else {
	        return _react2.default.createElement(
	          'form',
	          ...
	          _react2.default.createElement('input', { className: 'form-control', type: 'text', placeholder: 'Email' }),
	          _react2.default.createElement('input', { className: 'form-control', type: 'password', placeholder: 'Password' }),
	          _react2.default.createElement('input', { className: 'btn btn-success', type: 'submit', value: 'Login' })
	        );
	      }
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuickSpeechPage = function (_React$Component) {
	  _inherits(QuickSpeechPage, _React$Component);

	  function QuickSpeechPage() {
	    _classCallCheck(this, QuickSpeechPage);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(QuickSpeechPage).apply(this, arguments));
	  }

	  _createClass(QuickSpeechPage, [{
	    key: 'sayIt',
	    value: function sayIt(text) {
	      var msg = new window.SpeechSynthesisUtterance();
	      (0, _say_message.setVoice)(msg, 'Lee');
	      (0, _say_message.sayMessage)(msg, text);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _default.words.map(function (x, i) {
	            return _react2.default.createElement(
	              'button',
	              { key: i, onClick: function onClick() {
	                  return _this2.sayIt(x);
	                } },
	              x
	            );
	          })
	        ...
	        _react2.default.createElement(
	          ...
	          _default.phrases.map(function (x, i) {
	            return _react2.default.createElement(
	              'button',
	              { key: i, onClick: function onClick() {
	                  return _this2.sayIt(x);
	  ...
	  return QuickSpeechPage;
	}(_react2.default.Component);

	exports.default = QuickSpeechPage;
...
/***/ function(module, exports) {
	...
	var phrases = exports.phrases = ['How are you?', "I'm good", "What is your name?"];

	var words = exports.words = ['Hello', 'Welcome', 'Goodbye', 'Yes', 'No', 'Maybe'];
